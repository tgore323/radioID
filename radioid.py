...
# This program allows one to search the radio ID database (https://database.radioid.net/)
#
# This code is still under development. You may encounter issues. If so, please let 
# me know. You can always reach me via my email listed on QRZ (tgore323@gmail.com)
# 
# 73,
#       Tim Gore, KE6QBV
# 
